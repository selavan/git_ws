...
class IMUPublisher():
    ...
    def recvData(self):
        while True:
            ...
            #line = self.ser.readline()
            line = line.decode('utf-8', errors='ignore')  # Ignore decoding errors
