...
class Controller():
    def __init__(self, port= '/dev/ttyUSB0'): #'/dev/ttyUSB0', 'COM3'
        self.left_id = 2
        self.right_id = 1
    ...
    def move(self, spdL=100, spdR=100):
        ...
        cmdL = self.cmd(id=self.left_id, register_value=spdL)   ##importaint
        cmdR = self.cmd(id=self.right_id, register_value=-spdR) ##importaint
