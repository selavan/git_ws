...
class IMUNode(Node):
    def __init__(self):
        ...
        self.python_version = self.platform.python_version()[0] #not use --> need to check
            ...
            # ... Similar processing for other cases
                ...
                if self.checkSum(data_buff[0:10], data_buff[10]):
                    ...
                    if self.readreg == 0x0b:
	                    self.mag_offset = self.readval 
                    else:
	                    self.mag_range = self.readval
         ...
         if "mag" in msg.data:            
            ...
            if datalen > 0:
             ...
             try:
                 ...
                 #print(e)
                 self.get_logger().info('e %d', str(e))
